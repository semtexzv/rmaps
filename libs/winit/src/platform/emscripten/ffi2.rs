...
extern "C" {
    pub fn emscripten_asm_const_int(code: *const ::std::os::raw::c_char,
                                    arg_sigs:
                                    *const ::std::os::raw::c_char, ...)
                                    -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_asm_const_double(code: *const ::std::os::raw::c_char,
                                       arg_sigs:
                                       *const ::std::os::raw::c_char, ...)
                                       -> f64;
}
...
extern "C" {
    pub fn emscripten_webgl_get_drawing_buffer_size(context:
                                                    EMSCRIPTEN_WEBGL_CONTEXT_HANDLE,
                                                    width:
                                                    *mut ::std::os::raw::c_int,
                                                    height:
...
extern "C" {
    pub fn emscripten_set_canvas_element_size(target:
                                              *const ::std::os::raw::c_char,
...
extern "C" {
    pub fn emscripten_get_canvas_element_size(target:
                                              *const ::std::os::raw::c_char,
                                              width:
                                              *mut ::std::os::raw::c_int,
                                              height:
...
pub type VRDisplayHandle = i32;
pub type em_vr_callback_func = ::core::option::Option<unsafe extern "C" fn()>;
pub type em_vr_arg_callback_func =
::core::option::Option<unsafe extern "C" fn(arg1:
                                            *mut ::std::os::raw::c_void)>;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum VREye { VREyeLeft = 0, VREyeRight = 1, }
#[repr(C)]
#[derive(Debug, Copy)]
pub struct VRVector3 {
    pub x: f32,
    pub y: f32,
    pub z: f32,
}
#[test]
fn bindgen_test_layout_VRVector3() {
    assert_eq!(::core::mem::size_of::<VRVector3>() , 12usize , concat ! (
               "Size of: " , stringify ! ( VRVector3 ) ));
    assert_eq! (::core::mem::align_of::<VRVector3>() , 4usize , concat ! (
                "Alignment of " , stringify ! ( VRVector3 ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRVector3 ) ) . x as * const _ as usize }
                , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( VRVector3 ) , "::" ,
                stringify ! ( x ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRVector3 ) ) . y as * const _ as usize }
                , 4usize , concat ! (
                "Alignment of field: " , stringify ! ( VRVector3 ) , "::" ,
                stringify ! ( y ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRVector3 ) ) . z as * const _ as usize }
                , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( VRVector3 ) , "::" ,
                stringify ! ( z ) ));
}
impl Clone for VRVector3 {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
pub struct VRQuaternion {
    pub x: f32,
    pub y: f32,
    pub z: f32,
    pub w: f32,
...
#[test]
fn bindgen_test_layout_VRQuaternion() {
    assert_eq!(::core::mem::size_of::<VRQuaternion>() , 16usize , concat ! (
               "Size of: " , stringify ! ( VRQuaternion ) ));
    assert_eq! (::core::mem::align_of::<VRQuaternion>() , 4usize , concat ! (
                "Alignment of " , stringify ! ( VRQuaternion ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRQuaternion ) ) . x as * const _ as
            usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( VRQuaternion ) , "::" ,
                stringify ! ( x ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRQuaternion ) ) . y as * const _ as
            usize } , 4usize , concat ! (
                "Alignment of field: " , stringify ! ( VRQuaternion ) , "::" ,
                stringify ! ( y ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRQuaternion ) ) . z as * const _ as
            usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( VRQuaternion ) , "::" ,
                stringify ! ( z ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRQuaternion ) ) . w as * const _ as
            usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( VRQuaternion ) , "::" ,
                stringify ! ( w ) ));
}
impl Clone for VRQuaternion {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
pub struct VRDisplayCapabilities {
    pub hasPosition: i32,
    pub hasExternalDisplay: i32,
    pub canPresent: i32,
    pub maxLayers: ::std::os::raw::c_ulong,
}
#[test]
fn bindgen_test_layout_VRDisplayCapabilities() {
    assert_eq!(::core::mem::size_of::<VRDisplayCapabilities>() , 24usize ,
               concat ! ( "Size of: " , stringify ! ( VRDisplayCapabilities )
               ));
    assert_eq! (::core::mem::align_of::<VRDisplayCapabilities>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( VRDisplayCapabilities ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRDisplayCapabilities ) ) . hasPosition
            as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( VRDisplayCapabilities )
                , "::" , stringify ! ( hasPosition ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRDisplayCapabilities ) ) .
            hasExternalDisplay as * const _ as usize } , 4usize , concat !
                (
                "Alignment of field: " , stringify ! ( VRDisplayCapabilities )
                , "::" , stringify ! ( hasExternalDisplay ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRDisplayCapabilities ) ) . canPresent as
            * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( VRDisplayCapabilities )
                , "::" , stringify ! ( canPresent ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRDisplayCapabilities ) ) . maxLayers as
            * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( VRDisplayCapabilities )
                , "::" , stringify ! ( maxLayers ) ));
}
...
#[repr(C)]
#[derive(Debug, Copy)]
pub struct VRLayerInit {
    pub source: *const ::std::os::raw::c_char,
    pub leftBounds: [f32; 4usize],
    pub rightBounds: [f32; 4usize],
}
#[test]
fn bindgen_test_layout_VRLayerInit() {
    assert_eq!(::core::mem::size_of::<VRLayerInit>() , 40usize , concat ! (
               "Size of: " , stringify ! ( VRLayerInit ) ));
    assert_eq! (::core::mem::align_of::<VRLayerInit>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( VRLayerInit ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRLayerInit ) ) . source as * const _ as
            usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( VRLayerInit ) , "::" ,
                stringify ! ( source ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRLayerInit ) ) . leftBounds as * const _
            as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( VRLayerInit ) , "::" ,
                stringify ! ( leftBounds ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRLayerInit ) ) . rightBounds as * const
        _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( VRLayerInit ) , "::" ,
                stringify ! ( rightBounds ) ));
}
impl Clone for VRLayerInit {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
pub struct VRPose {
    ...
    pub position: VRVector3,
    /** Linear velocity, valid only if `poseFlags & VR_POSE_LINEAR_VELOCITY == 0` */
    pub linearVelocity: VRVector3,
    /** Linear acceleration, valid only if `poseFlags & VR_POSE_LINEAR_ACCELERATION == 0` */
    pub linearAcceleration: VRVector3,
    /** Orientation quaternion, valid only if `poseFlags & VR_POSE_ORIENTATION == 0` */
    pub orientation: VRQuaternion,
    /** Angular velocity, valid only if `poseFlags & VR_POSE_ANGULAR_VELOCITY == 0` */
    pub angularVelocity: VRVector3,
    /** Angular acceleration, valid only if `poseFlags & VR_POSE_ANGULAR_ACCELERATION == 0` */
    pub angularAcceleration: VRVector3,
    /** Bitmask of VR_POSE_* which determines whether the corresponding pose
     * attributes are valid */
    pub poseFlags: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout_VRPose() {
    assert_eq!(::core::mem::size_of::<VRPose>() , 80usize , concat ! (
               "Size of: " , stringify ! ( VRPose ) ));
    assert_eq! (::core::mem::align_of::<VRPose>() , 4usize , concat ! (
                "Alignment of " , stringify ! ( VRPose ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRPose ) ) . position as * const _ as
            usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( VRPose ) , "::" ,
                stringify ! ( position ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRPose ) ) . linearVelocity as * const _
            as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( VRPose ) , "::" ,
                stringify ! ( linearVelocity ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRPose ) ) . linearAcceleration as *
        const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( VRPose ) , "::" ,
                stringify ! ( linearAcceleration ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRPose ) ) . orientation as * const _ as
            usize } , 36usize , concat ! (
                "Alignment of field: " , stringify ! ( VRPose ) , "::" ,
                stringify ! ( orientation ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRPose ) ) . angularVelocity as * const _
            as usize } , 52usize , concat ! (
                "Alignment of field: " , stringify ! ( VRPose ) , "::" ,
                stringify ! ( angularVelocity ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRPose ) ) . angularAcceleration as *
        const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( VRPose ) , "::" ,
                stringify ! ( angularAcceleration ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRPose ) ) . poseFlags as * const _ as
...
pub struct VREyeParameters {
    pub offset: VRVector3,
    pub renderWidth: ::std::os::raw::c_ulong,
    pub renderHeight: ::std::os::raw::c_ulong,
}
#[test]
fn bindgen_test_layout_VREyeParameters() {
    assert_eq!(::core::mem::size_of::<VREyeParameters>() , 32usize , concat !
    ( "Size of: " , stringify ! ( VREyeParameters ) ));
    assert_eq! (::core::mem::align_of::<VREyeParameters>() , 8usize , concat !
    ( "Alignment of " , stringify ! ( VREyeParameters ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VREyeParameters ) ) . offset as * const _
            as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( VREyeParameters ) ,
                "::" , stringify ! ( offset ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VREyeParameters ) ) . renderWidth as *
        const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( VREyeParameters ) ,
                "::" , stringify ! ( renderWidth ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VREyeParameters ) ) . renderHeight as *
        const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( VREyeParameters ) ,
                "::" , stringify ! ( renderHeight ) ));
}
...
pub struct VRFrameData {
    pub timestamp: f64,
    pub leftProjectionMatrix: [f32; 16usize],
    pub leftViewMatrix: [f32; 16usize],
    pub rightProjectionMatrix: [f32; 16usize],
    pub rightViewMatrix: [f32; 16usize],
    pub pose: VRPose,
}
#[test]
fn bindgen_test_layout_VRFrameData() {
    assert_eq!(::core::mem::size_of::<VRFrameData>() , 344usize , concat ! (
               "Size of: " , stringify ! ( VRFrameData ) ));
    assert_eq! (::core::mem::align_of::<VRFrameData>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( VRFrameData ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRFrameData ) ) . timestamp as * const _
            as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( VRFrameData ) , "::" ,
                stringify ! ( timestamp ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRFrameData ) ) . leftProjectionMatrix as
            * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( VRFrameData ) , "::" ,
                stringify ! ( leftProjectionMatrix ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRFrameData ) ) . leftViewMatrix as *
        const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( VRFrameData ) , "::" ,
                stringify ! ( leftViewMatrix ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRFrameData ) ) . rightProjectionMatrix
            as * const _ as usize } , 136usize , concat ! (
                "Alignment of field: " , stringify ! ( VRFrameData ) , "::" ,
                stringify ! ( rightProjectionMatrix ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRFrameData ) ) . rightViewMatrix as *
        const _ as usize } , 200usize , concat ! (
                "Alignment of field: " , stringify ! ( VRFrameData ) , "::" ,
                stringify ! ( rightViewMatrix ) ));
    assert_eq! (unsafe {
        & ( * ( 0 as * const VRFrameData ) ) . pose as * const _ as
...
extern "C" {
    pub fn emscripten_vr_init(callback: em_vr_arg_callback_func,
                              userData: *mut ::std::os::raw::c_void)
                              -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_deinit() -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_version_major() -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_version_minor() -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_count_displays() -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_get_display_handle(displayIndex:
                                            ::std::os::raw::c_int)
                                            -> VRDisplayHandle;
}
extern "C" {
    pub fn emscripten_vr_set_display_render_loop(handle: VRDisplayHandle,
                                                 callback:
                                                 em_vr_callback_func)
                                                 -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_set_display_render_loop_arg(handle: VRDisplayHandle,
                                                     callback:
                                                     em_vr_arg_callback_func,
                                                     arg:
                                                     *mut ::std::os::raw::c_void)
                                                     -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_cancel_display_render_loop(handle: VRDisplayHandle)
                                                    -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_request_present(handle: VRDisplayHandle,
                                         layerInit: *mut VRLayerInit,
                                         layerCount: ::std::os::raw::c_int,
                                         callback: em_vr_arg_callback_func,
                                         userData:
                                         *mut ::std::os::raw::c_void)
                                         -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_get_frame_data(handle: VRDisplayHandle,
                                        frameData: *mut VRFrameData)
                                        -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_submit_frame(handle: VRDisplayHandle)
                                      -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_exit_present(handle: VRDisplayHandle)
                                      -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_get_display_name(handle: VRDisplayHandle)
                                          -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn emscripten_vr_get_eye_parameters(handle: VRDisplayHandle,
                                            whichEye: VREye,
                                            eyeParams: *mut VREyeParameters)
                                            -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_get_display_capabilities(handle: VRDisplayHandle,
                                                  displayCaps:
                                                  *mut VRDisplayCapabilities)
                                                  -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn emscripten_vr_display_connected(handle: VRDisplayHandle) -> bool;
}
extern "C" {
    pub fn emscripten_vr_display_presenting(handle: VRDisplayHandle) -> bool;
}
